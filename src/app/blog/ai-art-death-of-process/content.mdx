...
Matthew Crawford makes a related argument in *Shop Class as Soulcraft*. He writes about the mechanic who diagnoses an engine problem by listening. Not by running a diagnostic scan — by *listening*. The scan would be faster. The scan might even be more accurate. But the mechanic's way of knowing is fundamentally different. It's a form of attention, of being-in-relation-with the machine, that the scan eliminates entirely.
