...
function PrimaryProjectLinks({ product }: { product: Product }) {
...
function HeaderSection({ metrics, product, shared, statusConfig }: HeaderSectionProps) {
  return (
...
function HeroSection({ activeImage, onSelectImage, product, shared }: HeroSectionProps) {
  return (
    <Reveal>
      <motion.div
...
function CaseStudyOverview({ caseStudy }: { caseStudy: CaseStudy | undefined }) {
...
function ArchitectureSection({ slug }: { slug?: string }) {
...
function ProcessSection({ processSteps }: { processSteps: CaseStudyProcessStep[] }) {
  return (
    <Reveal>
...
function OutcomesSection({ caseStudy }: { caseStudy: CaseStudy | undefined }) {
  if (!caseStudy) return null;
...
function DetailsSection({ content }: { content: Product["content"] }) {
...
function RelatedProjectsSection({ relatedProjects }: { relatedProjects: Product[] }) {
...
function SidebarLinks({ product }: { product: Product }) {
  if (!product.demoUrl && !product.sourceUrl && !product.href) {
    return null;
  }
...
function ProjectSidebar({ pageSections, product }: SidebarProps) {
  return (
