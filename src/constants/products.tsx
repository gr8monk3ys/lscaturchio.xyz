...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: "unlinkd",
    thesis: "Get removed from the internet, and keep the proof",
    featured: true,
    categories: ["tools", "open-source"],
    status: "active",
    startDate: "2026-02",
  ...
  },
  {
    ...
    slug: "fraud-stream",
    thesis: "Score a transaction for fraud in milliseconds, not hours",
    featured: true,
  ...
  },
  {
    ...
    slug: "talker",
    thesis: "A teaching assistant that cites the syllabus",
    featured: true,
  ...
  },
  {
    ...
    thesis: "Trade on sentiment, with the risk management attached",
    featured: true,
  ...
  // ============================================
  {
    ...
    slug: "feedless",
    thesis: "Hide the distracting parts of Instagram and Facebook",
    featured: false,
    categories: ["tools", "open-source"],
    status: "archived",
    startDate: "2026-07",
  ...
  },
  {
    ...
    slug: "tidy-roll",
    thesis: "Swipe your camera roll clean",
    featured: false,
  ...
  },
  {
    ...
    slug: "pi-lab",
    thesis: "A whole homelab on one Raspberry Pi",
    featured: false,
    categories: ["tools", "open-source"],
    status: "maintained",
    startDate: "2026-02",
  ...
  },
  {
    ...
    slug: "qsensor-sim",
    thesis: "Quantum sensing for navigation without GPS",
    featured: false,
  ...
  },
  {
    ...
    slug: "blog-ai",
    thesis: "One idea, out as MDX or as a book",
    featured: false,
  ...
  // ============================================
  {
    ...
    thesis: "Summarise an academic paper",
    featured: false,
    categories: ["ai-ml", "tools"],
    status: "archived",
    startDate: "2021-02",
  ...
  },
  {
    ...
    slug: "healthcalc",
    thesis: "Health calculators that show their formula",
    featured: false,
  ...
  },
  {
    ...
    slug: "remedi",
    thesis: "Alternatives with the evidence attached",
    featured: false,
  ...
  },
  {
    ...
    slug: "numen",
    thesis: "Numerology as a reading, not a lucky number",
    featured: false,
    categories: ["web-apps"],
    status: "active",
    startDate: "2026-08",
  ...
  },
  {
    ...
    thesis: "One idea into an album blueprint",
    featured: false,
  ...
  },
  {
    ...
    slug: "link-flame",
    thesis: "A storefront where the screening is the product",
    featured: false,
    categories: ["web-apps"],
    status: "maintained",
    startDate: "2024-06",
