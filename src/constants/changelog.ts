...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "2025-01-18",
    changes: [
      { type: "highlight", text: "Redesign, and most of the sections the site still has" },
      ...
      { type: "added", text: "Related posts, matched on tags and embeddings" },
      ...
      { type: "added", text: "Public API, with docs at /api-docs" },
      { type: "changed", text: "Optimized images to WebP format (89.9% size reduction)" },
      { type: "changed", text: "Moved the site map into the footer so the header could stay slim" },
      { type: "changed", text: "Rebuilt the layouts that broke below 768px" },
      { type: "fixed", text: "TypeScript strict mode compliance" },
      { type: "fixed", text: "Skip link, focus rings, and contrast on the navbar and footer" },
    ],
  },
  {
    version: "1.0.0",
    ...
    changes: [
      ...
      { type: "added", text: "Projects, with a case study each" },
