...
The auditors specifically praised the "thorough documentation comments" from Monero developers. This is significant — security audits often reveal sloppy implementations, but FCMP++ passed with flying colors.
